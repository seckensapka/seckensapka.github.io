...
$(document).ready(function() {
    ...
    $("#wrapper").removeClass("main-wrapper").addClass("bordered");

    if ($("body").hasClass("bordered")) {
        if($("#wrapper").is(":visible")) {

        }else {
            $("body > header, body > section, body > div , body > aside , body > footer").wrapAll('<div id="wrapper" class="bordered"></div>');
        }

        $("body").find("#wrapper").removeClass("main-wrapper");
        $("body").find("#wrapper").addClass("bordered");
